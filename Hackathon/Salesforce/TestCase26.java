...
public class TestCase26 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		m.sendKeys(driver.findElement(By.xpath("//input[@id='fname']")),"abcd");
		Thread.sleep(3000);
		m.sendKeys(driver.findElement(By.xpath("//input[@id='devname']")),"efgh");
		Thread.sleep(3000);
		m.byXpath(driver, "//body[1]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/div[2]/form[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/input[1]");
		Thread.sleep(3000);
		driver.close();
	}
